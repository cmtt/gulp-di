...
module.exports = (function () {
  ...
  function $module (key, fn, type) {
    ...
    this.resolver.provide(key, info.dependencies, info.fn, type || 'module');
    return this;
  }
  ...
  function $injector(arg) {
    ...
    return info.fn.apply(this, info.dependencies.map(this.byId));
  }
  ...
  function $parseArg(arg) {
    ...
    // function (dependency) {}
      ...
      dependencies = info.arguments.slice();
      fn = arg;
    } else {
